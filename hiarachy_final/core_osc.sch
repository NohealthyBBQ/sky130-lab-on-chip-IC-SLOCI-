...
N 990 -350 990 -330 {
lab=S4B}
C {hiarachy_final/core_osc_amp.sym} 40 -60 0 0 {name=X1}
C {hiarachy_final/core_osc_amp.sym} 280 -60 0 0 {name=X2}
C {hiarachy_final/core_osc_amp.sym} 520 -60 0 0 {name=X3}
C {hiarachy_final/core_osc_amp.sym} 760 -60 0 0 {name=X4}
