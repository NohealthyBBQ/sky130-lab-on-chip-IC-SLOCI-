...
C {sky130_fd_pr/cap_mim_m3_1.sym} 140 -110 0 0 {name=C1 model=cap_mim_m3_1 W=30 L=50 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 270 -210 0 0 {name=M1
L=0.15
W=8
nf=8
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 480 -210 0 0 {name=M2
L=0.15
W=8
nf=8
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 630 -210 0 0 {name=M3
L=0.15
W=8
nf=8
mult=1
