...
S {}
E {}
T {R3 = 1.23k} -650 -260 0 0 0.4 0.4 {}
T {Itail = 100uA
...
C {opamp/opamp_realcomp3_usefinger.sym} -740 -460 1 1 {name=x1}
C {opamp/opamp_realcomp3_usefinger.sym} 440 -420 0 0 {name=x2}
...
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_5p73.sym} 320 -160 3 0 {name=R7
W=5.73
L=109
model=res_xhigh_po_5p73
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_5p73.sym} 380 -160 3 0 {name=R8
W=5.73
L=109
model=res_xhigh_po_5p73
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_5p73.sym} 440 -160 3 0 {name=R9
W=5.73
L=109
model=res_xhigh_po_5p73
spiceprefix=X
