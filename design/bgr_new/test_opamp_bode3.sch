...
N 340 -60 500 -60 { lab=Vout}
N 500 -160 500 -60 { lab=Vout}
...
C {devices/code.sym} 400 -540 0 0 {name=SIM only_toplevel=false value="
.param temp=27
...
"}
C {sky130_fd_pr/corner.sym} 590 -530 0 0 {name=CORNER only_toplevel=true corner=tt}
