...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 560 -200 0 1 {name=M_diff_p
L=2
W=12
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 380 -340 0 1 {name=M_ppair_n
L=2
W=12
nf=1
mult=8
...
C {devices/opin.sym} 590 -270 0 0 {name=p5 lab=out}
C {devices/ipin.sym} 0 -160 0 0 {name=p6 lab=bias_10u}
C {vsource.sym} 300 -50 0 0 {name=V1 value=0.7}
