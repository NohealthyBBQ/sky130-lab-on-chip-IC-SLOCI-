...
N 680 -60 720 -60 { lab=bias_10u}
N 680 -110 680 -60 { lab=bias_10u}
N 380 -110 680 -110 { lab=bias_10u}
N 100 -110 100 -90 { lab=bias_10u}
N 140 -60 180 -60 { lab=bias_10u}
N 180 -110 180 -60 { lab=bias_10u}
N 380 -60 410 -60 { lab=bias_10u}
N 380 -110 380 -60 { lab=bias_10u}
...
N 540 -280 720 -280 { lab=#net3}
N 450 -0 470 0 { lab=vss}
N 360 -140 450 -140 { lab=#net1}
N 360 -200 470 -200 { lab=vss}
N 100 -110 180 -110 { lab=bias_10u}
N 180 -110 380 -110 { lab=bias_10u}
...
C {devices/iopin.sym} 0 -400 0 1 {name=p1 lab=vdd}
C {devices/iopin.sym} 0 0 0 1 {name=p2 lab=vss}
C {devices/ipin.sym} 300 -200 0 0 {name=p3 lab=in_n}
C {devices/ipin.sym} 600 -200 0 1 {name=p4 lab=in_p}
C {devices/opin.sym} 820 -200 0 0 {name=p5 lab=out}
C {devices/ipin.sym} 0 -160 0 0 {name=p6 lab=bias_10u}
